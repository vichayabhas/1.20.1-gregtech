...
ServerEvents.recipes((event) => {
    ...
    event.recipes.gtceu.centrifuge('test2')
        .inputFluids(Fluid.of('gtceu:naquadria_waste', 19000))
        .itemOutputs('58x gtceu:antimony_trifluoride_dust')
        .itemOutputs(Item.of('gtceu:gallium_sulfide_dust', 38))
        .itemInputs(Item.of('bucket', 44))
        .outputFluids(Fluid.of('gtceu:fluorine', 88000))
        .outputFluids(Fluid.of('gtceu:oxygen', 88000))
        .outputFluids(Fluid.of('gtceu:sulfuric_acid', 124500))
        .outputFluids(Fluid.of('water', 12000))
        .outputFluids(Fluid.of('gtceu:hydrofluoric_acid', 14500))
        .outputFluids(Fluid.of('gtceu:hydrogen',73500))
        .itemOutputs(Item.of('water_bucket', 44))
        .EUt(5)
        .circuit(2)
        .duration(5)
